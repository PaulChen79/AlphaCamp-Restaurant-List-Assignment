...
router.put('/:id/edit', async (req, res) => {
	try {
		...
		await Restaurants.findOneAndUpdate({ _id, userId }, { name, category, location, phone, description, image, google_map, userId })
...
router.delete('/:id', async (req, res) => {
	try {
		const userId = req.user._id
		const _id = req.params.id
		await Restaurants.findOneAndDelete({ _id, userId })
